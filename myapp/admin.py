...
conn.execute('''CREATE TABLE IF NOT EXISTS TRANS ( username varchar(15) NOT NULL, tid varchar(10) NOT NULL, date TEXT(10) NOT NULL, company VARCHAR(15) NOT NULL, quantity TEXT(6) NOT NULL, tp VARCHAR(7) NOT NULL, TTYPE TEXT(4), TOTAL VARCHAR(12) NOT NULL, comment VARCHAR (50) )''')
conn.execute('''CREATE TABLE IF NOT EXISTS HOLDINGS( username varchar(15) NOT NULL, quantity INT NOT NULL, tp VARCHAR NOT NULL, COMPANY VARCHAR(2) NOT NULL, TOTAL VARCHAR NOT NULL) ''')
conn.execute('''CREATE TABLE IF NOT EXISTS STOCKS( COMPANY varchar(15) PRIMARY KEY NOT NULL, CMP VARCHAR NOT NULL, OPEN VARCHAR NOT NULL, CLOSE VARCHAR NOT NULL, LOW VARCHAR NOT NULL, HIGH VARCHAR NOT NULL,  CHANGE VARCHAR NOT NULL) ''')
