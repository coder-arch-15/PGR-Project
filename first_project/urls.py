...
urlpatterns = [
    ...
    path('update3shownifty500',Nifty500.update3shownifty500),
    path('update4shownifty500',Nifty500.update4shownifty500),
    path('update5shownifty500',Nifty500.update4shownifty500),
    path('update6shownifty500',Nifty500.update4shownifty500),
    path('update7shownifty500',Nifty500.update4shownifty500),
    path('update8shownifty500',Nifty500.update4shownifty500),
